...
ro.mediatek.version.branch=alps-mp-n1.mp18\
ro.mediatek.version.release=Coolpad_1822-C0_V1.0\
    ...
    ro.custom.version.release=R08\
    ro.copyfile.persist=1 \
    ro.mtk.build.verno=R08 \
    ro.hct_extra_ringtone_show_more=1 \
    ro.hct_multi_finger_gesture=1 \
    ro.hct_no_browser_navigation=1 \
    ro.hct_single_screen=yes \
    ...
    ro.hct_support_screenrecord=1 \
    ro.hct_screen_shot=1 \
    ro.hct_suport_anr_tools=1 \
    ro.hct_fastcameravideo=1 \
    ro.miguo_custom_dialpad=1 \
    ro.config.random_lockscreen=1 \
    ro.gangyun_camera_beauty=1 \
    ro.hct_white_list=1 \
    ro.hct_step_record=1 \
    ro.hct_ask_search=1 \
    ro.hct_stereo_camera=1 \
    ro.hct_long_screen_shot=1 \
    ro.hct_system_manager=1 \
    ro.hct_navigation_bar_style=1 \
    ro.leb_parallel_space=1 \
    ro.hct_fingerprint=1 \
    persist.sys.sw.key.mod=1 \
    persist.sys.sw.verify.retry=3 \
